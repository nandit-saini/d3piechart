...
PieChart.prototype.setTooltipPadding = (padding) => {

	this.config.tooltipOptions.padding = padding;
};

PieChart.prototype.setTooltipBackgroundColor = (backgroundColor) => {

	this.config.tooltipOptions.backgroundColor = backgroundColor;
};

PieChart.prototype.setTooltipBorderRadius = (borderRadius) => {

	this.config.tooltipOptions.borderRadius = borderRadius;
};

PieChart.prototype.setTooltipBoxShadow = (boxShadow) => {

	this.config.tooltipOptions.boxShadow = boxShadow;
};

PieChart.prototype.setTooltipLabelFontSize = (fontSize) => {

	this.config.tooltipOptions.labelText.fontSize = fontSize;
};

PieChart.prototype.setTooltipLabelFontFamily = (fontFamily) => {

	this.config.tooltipOptions.labelText.fontFamily = fontFamily;
};

PieChart.prototype.setTooltipLabelFontWeight = (fontWeight) => {

	this.config.tooltipOptions.labelText.fontWeight = fontWeight;
};

PieChart.prototype.setTooltipLabelFontColor = (fontColor) => {

	this.config.tooltipOptions.labelText.fontColor = fontColor;
};
...
PieChart.prototype.createPieChart = () => {
	...
	const tooltip = d3.select("body")
    	...
    	.style("padding", tooltipOptions.padding+"px")
    	.style("background-color", tooltipOptions.backgroundColor+"px")
    	.style("-webkit-border-radius", tooltipOptions.borderRadius+"px")
    	.style("-moz-border-radius", tooltipOptions.borderRadius+"px")
    	.style("border-radius", tooltipOptions.borderRadius)
    	.style("-webkit-box-shadow", tooltipOptions.boxShadow)
    	.style("-mox-box-shadow", tooltipOptions.boxShadow)
    	.style("box-shadow",tooltipOptions.boxShadow)

	tooltip.append("div")
		.attr("class","data1")
		.style("font-size",tooltipOptions.labelText.fontSize+"px")
		.style("font-family",tooltipOptions.labelText.fontFamily)
		.style("font-weight",tooltipOptions.labelText.fontWeight)
		.style("color",tooltipOptions.labelText.fontColor);
